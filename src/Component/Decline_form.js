        ...
        <div className='row'>
          ...
          <Card className='card_12378 text-center d-flex justify-content-center align-items-center cod' style={{
            ...
            <Card.Body>
              ...
              <p className='p14'>Others </p><BsCircle className='icon-custom-color_1 '/>

              {/* <p className='p15'>Please select reason for decline</p> */}
<p className='p16 text-start ' >Please contact partnersupport @CareerManiaa.in for raising any concerns.You can also resume onboarding later after entering Owner Mobile Number.</p>
