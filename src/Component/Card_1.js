        ...
        <div className='row justify-content-center'>
          <div className='col-12 col-md-6'>
            ...
            <div className={`btn1 mt-4 ${button2Active ? '' : 'disabled'}`} onClick={() => handleButtonClick(1)}>
              ...
              <p className='txt1'>Classes/Educators</p>              <img src={img5} alt="" className="img-fluid logo_2_2" />

            </div>
            <div className={`btn1 my-4 ${button3Active ? '' : 'disabled'}`} >
              <img src={img4} alt="" className="img-fluid logo_1 " />
              <p className='txt1'>Colleges/Institution</p><img src={img5} alt="" className="img-fluid logo_2_3" />
            </div>
          </div>
        </div>
      </div>
